...
@section('main-body')
    ...
    <div ng-app="adminServicesCreate">
        <div class="wrapper wrapper-content animated fadeInRight" ng-controller="adminServicesCreateCtrl"
             ng-init="init('{!! Session::get("userToken")!!}')">
            <div class="row">
                <div class="col-lg-12">
...
@section('module-scripts')
    {!! Html::script('js/modules/admin/services/create.js') !!}
@endsection
